...
@NamedQueries({
    ...
    @NamedQuery(name = "Contato.findByTelOpc", query = "SELECT c FROM Contato c WHERE c.telOpc = :telOpc")})
public class Contato implements Serializable {
    ...
    public String getTelOpc() {
        return telOpc;
    }

    public void setTelOpc(String telOpc) {
        this.telOpc = telOpc;
    }
