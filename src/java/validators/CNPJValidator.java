...
public class CNPJValidator implements Validator {
     ...
     public void validate(FacesContext arg0, UIComponent arg1, Object valorTela) throws ValidatorException {
          if (!validaCNPJ(limparString(String.valueOf(valorTela)))) {
               FacesMessage message = new FacesMessage();
               message.setSeverity(FacesMessage.SEVERITY_ERROR);
               message.setSummary(ResourceBundle.getBundle("/Bundle").getString("CNPJInvalido"));
               throw new ValidatorException(message);
          }
     }
 
     public String limparString(String cnpj){
