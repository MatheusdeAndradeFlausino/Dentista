...
public class CPFValidator implements Validator{
     ...
     public void validate(FacesContext arg0, UIComponent arg1, Object valorTela) throws ValidatorException {
         ...
         if (!validaCPF(limparString(String.valueOf(valorTela)))) {
               FacesMessage message = new FacesMessage();
               message.setSeverity(FacesMessage.SEVERITY_ERROR);
               message.setSummary(ResourceBundle.getBundle("/Bundle").getString("CPFInvalido"));
               throw new ValidatorException(message);
          }
     }
     
     public String limparString(String cpf){
         String result = cpf.substring(0, 3);
         result += cpf.substring(4, 7);
         result += cpf.substring(8, 11);
         result += cpf.substring(12, 14);
         return result;
     }
